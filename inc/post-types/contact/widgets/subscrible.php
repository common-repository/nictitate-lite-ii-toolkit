...
add_action( 'widgets_init', array( 'Nictitate_Toolkit_II_Widget_Subscribe', 'register_widget' ) );
class Nictitate_Toolkit_II_Widget_Subscribe extends Kopa_Widget {

	public $kpb_group = 'contact';

	public static function register_widget() {
		register_widget( 'Nictitate_Toolkit_II_Widget_Subscribe' );
	}

	public function __construct() {
		$this->widget_cssclass    = 'k-widget-newsletter-2 has-header has-background ';
		$this->widget_description = esc_html__( 'Displays subscribe form.', 'nictitate-lite-ii-toolkit' );
		$this->widget_id          = 'nictitate-toolkit-ii-widget-subscrible';
		$this->widget_name        = esc_html__( '__Subscrible', 'nictitate-lite-ii-toolkit' );
