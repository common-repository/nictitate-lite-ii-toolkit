...
add_filter( 'kpb_get_widgets_list', array( 'Nictitate_Toolkit_II_Widget_Skill_Counter', 'register_block' ) );

class Nictitate_Toolkit_II_Widget_Skill_Counter extends Kopa_Widget {

	public $kpb_group = 'skill';
	
	public static function register_block( $blocks ) {
        $blocks['Nictitate_Toolkit_II_Widget_Skill_Counter'] = new Nictitate_Toolkit_II_Widget_Skill_Counter();
        return $blocks;
    }

	public function __construct() {
		$this->widget_cssclass    = 'k-widget-number';
		$this->widget_description = esc_html__( 'Display skill progress.', 'nictitate-lite-ii-toolkit' );
		$this->widget_id          = 'kopa-skill-counter';
		$this->widget_name        = esc_html__( '__Skill Counter', 'nictitate-lite-ii-toolkit' );
