...
add_action( 'kpb_get_widgets_list', array( 'Nictitate_Toolkit_II_Widget_Posts_List_Carousel', 'register_block' ) );
	
class Nictitate_Toolkit_II_Widget_Posts_List_Carousel extends Kopa_Widget {

	public $kpb_group = 'post';
	
	public static function register_block( $blocks ) {
       	$blocks['Nictitate_Toolkit_II_Widget_Posts_List_Carousel'] = new Nictitate_Toolkit_II_Widget_Posts_List_Carousel();
        return $blocks;
    }
    
	public function __construct() {
		$this->widget_cssclass    = 'k-widget-post-carousel has-header has-icon-header has-background';
		$this->widget_description = esc_html__( 'Display a posts list carousel widget.', 'nictitate-lite-ii-toolkit' );
		$this->widget_id          = 'nictitate-toolkit-ii-widget-posts-list-carousel';
		$this->widget_name        = esc_html__( '__Posts List Carousel', 'nictitate-lite-ii-toolkit' );
