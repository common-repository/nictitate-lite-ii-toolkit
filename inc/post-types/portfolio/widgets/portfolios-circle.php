...
add_action( 'kpb_get_widgets_list', array( 'Nictitate_Toolkit_II_Widget_Portfolios_Circle', 'register_block' ) );
	
class Nictitate_Toolkit_II_Widget_Portfolios_Circle extends Kopa_Widget {

	public $kpb_group = 'portfolio';
	
	public static function register_block( $blocks ) {
       	$blocks['Nictitate_Toolkit_II_Widget_Portfolios_Circle'] = new Nictitate_Toolkit_II_Widget_Portfolios_Circle();
        return $blocks;
    }
	...
	public function __construct() {
		...
		$this->widget_description = esc_html__( 'Display a portfolios circle widget.', 'nictitate-lite-ii-toolkit' );
		$this->widget_id          = 'nictitate-toolkit-ii-widget-portfolios-circle';
		$this->widget_name        = esc_html__( '__Portfolios Circle', 'nictitate-lite-ii-toolkit' );
		$this->settings 		  = array(
			'title'  => array(
				'type'  => 'text',
				'std'   => '',
