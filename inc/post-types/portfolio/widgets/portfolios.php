...
add_action( 'kpb_get_widgets_list', array( 'Nictitate_Toolkit_II_Widget_Portfolios', 'register_block' ) );
	
class Nictitate_Toolkit_II_Widget_Portfolios extends Kopa_Widget {

	public $kpb_group = 'portfolio';
	
	public static function register_block( $blocks ) {
       	$blocks['Nictitate_Toolkit_II_Widget_Portfolios'] = new Nictitate_Toolkit_II_Widget_Portfolios();
        return $blocks;
    }
	...
	public function __construct() {
		...
		$this->widget_description = esc_html__( 'Display a portfolios widget.', 'nictitate-lite-ii-toolkit' );
		$this->widget_id          = 'nictitate-toolkit-ii-widget-portfolios';
		$this->widget_name        = esc_html__( '__Portfolios', 'nictitate-lite-ii-toolkit' );
		$this->settings 		  = array(
			'title'  => array(
				'type'  => 'text',
				'std'   => '',
			...
			<?php if ( $result_set->have_posts() ) : ?>
				<div class="widget-content">
					...
					<div class="text-center">
						<a href="<?php echo get_post_type_archive_link( 'portfolio' ); ?>" class="read-more read-more-border"><?php esc_html_e( 'view all portfolio', 'nictitate-lite-ii-toolkit' ); ?></a>
					</div>
				</div>
			<?php endif; ?>
		<?php
