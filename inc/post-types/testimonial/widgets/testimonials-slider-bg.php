...
add_action( 'kpb_get_widgets_list', array( 'Nictitate_Toolkit_II_Widget_Testimonials_Slider_Background_Content', 'register_block' ) );
	
class Nictitate_Toolkit_II_Widget_Testimonials_Slider_Background_Content extends Kopa_Widget {

	public $kpb_group = 'testimonial';
	
	public static function register_block( $blocks ) {
       	$blocks['Nictitate_Toolkit_II_Widget_Testimonials_Slider_Background_Content'] = new Nictitate_Toolkit_II_Widget_Testimonials_Slider_Background_Content();
        return $blocks;
    }
	...
	public function __construct() {
		...
		$this->widget_description = esc_html__( 'Display a testimonials slider widget. Background content.', 'nictitate-lite-ii-toolkit' );
		$this->widget_id          = 'nictitate-toolkit-ii-widget-testimonials-slider-background-content';
		$this->widget_name        = esc_html__( '__Testimonials Slider BG', 'nictitate-lite-ii-toolkit' );
		$this->settings 		  = array(
			'title'  => array(
				'type'  => 'text',
				'std'   => '',
