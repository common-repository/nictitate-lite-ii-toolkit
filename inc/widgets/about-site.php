...
add_action( 'widgets_init', array( 'Nictitate_Lite_II_Toolkit_Widget_About_Site', 'register_widget' ) );

class Nictitate_Lite_II_Toolkit_Widget_About_Site extends Kopa_Widget {

    public $kpb_group = 'other';

    public static function register_widget() {
        register_widget( 'Nictitate_Lite_II_Toolkit_Widget_About_Site');
    }

    public function __construct() {
        $this->widget_cssclass    = ' widget_text';
        $this->widget_description = esc_html__( 'Show about the site.', 'nictitate-lite-ii-toolkit' );
        $this->widget_id          = 'nictitate_toolkit_ii-about-site';
        $this->widget_name        = esc_html__( '__About Site', 'nictitate-lite-ii-toolkit' );
        ...
        $this->settings 		  = array(
            ...
            'des_site'  => array(
                'type'  => 'textarea',
                'std'   => '',
                'label' => esc_html__( 'Description the site:', 'nictitate-lite-ii-toolkit' )
            )
        );
    ...
    public function widget( $args, $instance ) {
        ...
        if ( ! empty($title) ): ?>
       	...
       	<div class="textwidget">
           	...
           	<?php endif; ?>
            <?php
            $nictitate_lite_ii_toolkit_socials = nictitate_lite_ii_get_socials();
            $social_links = array();
            foreach ( $nictitate_lite_ii_toolkit_socials as $social ) {
