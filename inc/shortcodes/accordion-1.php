...
add_filter('nictitate_lite_ii_toolkit_get_elements', 'nictitate_toolkit_ii_register_elements_accordion');

function nictitate_toolkit_ii_register_elements_accordion($groups){
	$groups['accordions'][] = array(
		'name' => esc_html__('Accordion 1','nictitate-lite-ii-toolkit'),
...
add_shortcode('accordions', 'nictitate_toolkit_ii_accordions');
add_shortcode('accordion', '__return_false' );

function nictitate_toolkit_ii_accordions( $atts, $content = null){
	...
	$tab_classes = apply_filters('nictitate_toolkit_ii_shortcode_accordions_classes', 'style-1', $style_id );
	...
	$matches = nictitate_lite_ii_toolkit_extract_shortcodes( $content, true, array( 'accordion' ) );
	...
	return apply_filters( 'nictitate_toolkit_ii_accordions', $string, $atts, $content );
